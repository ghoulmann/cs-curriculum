...
* demonstrate the use of for and while loops;
...
* use logical reasoning to explain how a simple alogrithnm works and to detect and correct errors in algorithms and programs (Computing);
